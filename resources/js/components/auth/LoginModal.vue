  ...
  <Dialog :open="open" @update:open="emit('update:open', $event)">
    <DialogContent class="sm:max-w-[420px] p-8 rounded-2xl border-none">
      ...
      <div class="text-center mb-8 mt-2">
        <img src="/images/logo_Black.png" alt="Spotlight Logo" class="mx-auto w-36 mb-4" />
      ...
      <div class="space-y-4">
        ...
        <div class="relative">
          ...
          <input v-model="email" type="email" placeholder="Email" class="w-full pl-11 p-3 rounded-full border outline-none text-[#222222]" />
        </div>

        <!-- PASSWORD -->
        <div class="relative">
          <LockClosedIcon class="w-5 h-5 text-gray-400 absolute left-4 top-3.5"/>
          <input v-model="password" type="password" placeholder="Password" class="w-full pl-11 p-3 rounded-full border outline-none text-[#222222]" @keyup.enter="login" />
        </div>
